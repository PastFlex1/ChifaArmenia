...
import { ChefHat, Plus, Trash2, Edit2, Search, X, Download } from 'lucide-react';
  ...
  return (
    <div className="flex w-full h-full gap-4 overflow-y-auto xl:overflow-hidden flex-col xl:flex-row pb-[80px] xl:pb-0">
      ...
      <div className="w-full xl:w-[450px] flex flex-col gap-4 shrink-0">
        <div className="bg-white border-2 border-black rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-6 xl:h-full xl:overflow-y-auto scrollbar-hide">
