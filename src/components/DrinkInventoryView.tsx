...
import { CupSoda, Plus, Trash2, Edit2, Search, X } from 'lucide-react';
  ...
  return (
    <div className="flex w-full h-full gap-4 overflow-hidden flex-col md:flex-row">
      <div className="w-full md:w-[400px] flex flex-col gap-4 overflow-hidden shrink-0">
        <div className="bg-white p-6 rounded-2xl border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full overflow-y-auto scrollbar-hide">
